          ...
          <div class="ml-auto w-25">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu site-menu-dark js-clone-nav mr-auto d-none d-lg-block m-0 p-0">
                <li class="cta"><a href="data_kurir.php" class="nav-link"><span>Kembali</span></a></li>
              </ul>
            </nav>
        ...
        <?php
            if(isset($_GET["form"])){
                ...
                <div class='col-lg-8 ml-auto mt-1' data-aos='fade-up' data-aos-delay='100'>
                    ...
                    <h3 class='h4 text-black mb-2'>Edit Data Kurir</h3>
                    <form action='../controller/controller_kurir.php' method='post'>
                        ...
                        <div class='form-group form-row'>
                            <div class='form-group col-6'>
                                 <label for='tarif-minimum'>Tarif Minimum</label>
                                <input class='form-control' type='text' name='tarif_minimum' value='$d[tarif_min]' required placeholder='Masukkan Tarif Minimum Kurir'>
                            </div>
                            <div class='form-gorup col-6'>
                                <label for='tarif-km'>Tarif per-Km</label>
                                <input class='form-control' type='text' name='tarif_km' value='$d[tarif_km]' required placeholder='Masukkan Tarif Per-Km Kurir'>
                            </div>
                        </div>
                ...
                <div class='col-lg-8 ml-auto mt-1' data-aos='fade-up' data-aos-delay='100'>
                    ...
                    <form action='../controller/controller_kurir.php' method='post'>
                        <div class='form-row'>
                            <div class='form-group col-12'>
                                <label for='label-kurir'>Label Kurir</label>
                                <input class='form-control' type='text' name='label_kurir' required placeholder='Masukkan Label Kurir'>
                            </div>
                        </div>
                        <div class='form-group form-row'>
                            <div class='form-group col-6'>
                                 <label for='tarif-minimum'>Tarif Minimum</label>
                                <input class='form-control' type='text' name='tarif_minimum' required placeholder='Masukkan Tarif Minimum Kurir'>
                            </div>
                            <div class='form-gorup col-6'>
                                <label for='tarif-km'>Tarif per-Km</label>
                                <input class='form-control' type='text' name='tarif_km' required placeholder='Masukkan Tarif Per-Km Kurir'>
                            </div>
                        </div>
