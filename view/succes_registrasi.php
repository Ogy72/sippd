          ...
          <div class="mx-auto text-center">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block  m-0 p-0">
                <li><a href="#home-section" class="nav-link">Registrasi Berhasil</a></li>
              </ul>
            </nav>
          </div>
      ...
      <div class="slide-1" style="background-image: url('../images/hero_1.jpg');" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row">
               ...
               <!-- from Registrasi -->
                <div class="col-lg-10 form-box-success" style="margin-top:150px" data-aos="fade-up" data-aos-delay="500">
 
                   <h3 class="h4 text-black mb-4">Registrasi Berhasil</h3>
                   Terimakasih Sudah Mendaftar <br> 
                   Harap Cek Email Anda dan Klik Tautan Konfirmasi Untuk Mengaktifkan Akun Anda <br>
                    <?php 
                        if(isset($_GET['link'])){
                            $link = $_GET['link'];
                            echo " <a href='../controller/controller_registrasi.php?akun=$link'>Konfirmasi Registrasi</a>";
                        }
                    ?>
