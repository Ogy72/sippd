            ...
            <div class="col-12">
              ...
              <div class="row">
                ...
                <div class="col-lg-12 ml-auto mt-1" style='color:black' data-aos="fade-up" data-aos-delay="100">
                  <div class="form-box">
                    <h3 class="h4 text-black mb-2">Data User</h3>
                    <a href="form_user.php" class="btn-sm btn-primary mb-2" style="float:right">Tambah Data User</a>
                    <table class="table table-bordered table-hover table-sm">
                        ...
                        foreach($rd as $d){
                            ...
                            <td style='text-align:center'>
                                <a href='form_user.php?form=edit&kd=$d[username]' class='btn-sm btn-secondary'>Edit</a>
                                <a href='../controller/controller_user.php?kd=$d[username]' class='btn-sm btn-danger'>Hapus</a>
                            </td>
                            </tr>";
                        }
                        ?>
