                ...
                <div class="site-section courses-entry-wrap"  data-aos="fade-up" data-aos-delay="100">
                    <div class="container">
                        ...
                        <div class='bg-white  align-self-stretch' style='color:black'>
                            ...
                            <h3 style='font-weight:bold' class='mb-4'>Daftar Informasi Website</h3>
                            <table class="table table-bordered table-hover">
                                <thead class="thead-dark">
                                    <tr>
                                        <th width="10%">Kategori</th>
                                        <th width="23%">Judul</th>
                                        <th width="37%">Konten</th>
                                        <th width="16%">Tgl Post/Berlaku</th>
                                ...
                                echo"
                                    <tr>
                                        ...
                                        <td>$d[tgl_post]</td>
                                        <td>
                                            <a href='edit_informasi.php?id=$d[id]' class='btn-sm btn-info'>Edit</a>
                                            <a href='../controller/controller_informasi.php?id=$d[id]' class='btn-sm btn-danger'>Hapus</a>
                                        </td>
                                    </tr>";
                                }
                                ?>
